...
worker.add_insecure_port('[::]:50053')

master.add_node(MasterImpl_pb2.Worker(worker='localhost:50053'))
worker.start()
...
try:
    ...
    master.remove_node(MasterImpl_pb2.Worker(worker='localhost:50053'))
    worker.stop(0)
